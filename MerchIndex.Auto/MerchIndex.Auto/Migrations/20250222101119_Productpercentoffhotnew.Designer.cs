...
namespace MerchIndex.Auto.Migrations
{
    ...
    [Migration("20250222101119_Productpercentoffhotnew")]
    partial class Productpercentoffhotnew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MerchIndex.Auto.Client.Models.CartLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MerchIndex.Auto.Client.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MerchIndex.Auto.Client.Models.CartLine", b =>
                {
                    b.HasOne("MerchIndex.Auto.Client.Models.Order", null)
                        .WithMany("Lines")
                        .HasForeignKey("OrderId");

                    b.HasOne("MerchIndex.Auto.Client.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MerchIndex.Auto.Client.Models.Person", b =>
                {
                    b.HasOne("MerchIndex.Auto.Client.Models.Department", "Department")
                        .WithMany("People")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MerchIndex.Auto.Client.Models.Location", "Location")
                        .WithMany("People")
            ...
            modelBuilder.Entity("MerchIndex.Auto.Client.Models.Product", b =>
                {
                    b.HasOne("MerchIndex.Auto.Client.Models.Company", "Company")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MerchIndex.Auto.Data.ApplicationUser", null)
                        .WithMany()
